...
const partnerships = [
  {
    ...
    description: "A long-term, high-level collaboration with organizations committed to advancing rural girls' development across multiple initiative",
    icon: Target,
    details: {
      contribute: [
...

  {
    ...
    description: "A collaboration focused on a specific initiative such as school outreaches, menstrual hygiene campaigns, or skill-building workshops.",
    icon: BookOpen,
    details: {
      contribute: [
...

  {
    ...
    description: "A partnership centered on finanicial contributions to support programs or operational needs.",
    icon: DollarSign,
    details: {
      contribute: [
        "Direct funding",
...

  {
    ...
    description: "A collaboration with individuals or organizations that provide expertise, training, or educational resources to empower rural girls.",
    icon: Lightbulb,
    details: {
      contribute: [
...

  {
    ...
    description: "A partnership with grassroots stakeholders that enable acess to rural communities and supports local engagement.",
    icon: Users2,
    details: {
      contribute: [
...

  {
    ...
    description: "A partnership focused on amplifying RUGAN's work and sharing the stories of rural girls.",
    icon: Megaphone,
    details: {
      contribute: [
...

  {
    ...
    description: "A structured collaboration with individuals or groups who contribute time and effort to support RUGAN's activities",
    icon: Heart,
    details: {
      contribute: [
...

  {
    ...
    description: "A formal collaboration with companies seeking to achieve their CSR objectives through girl-child empowerment initiatives.",
    icon: Building2,
    details: {
      contribute: [
        "Program funding",
    ...
    <>
      ...
      <div className='container-rugan'>
        <div>
          ...
          >
            {partnerships.map((faq, i) => (
              <PartnershipItems key={i} {...faq} />
            ))}
          </div>
        </div>
      </div>
